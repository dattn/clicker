...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;return _vm._h('div',[_vm._h('fieldset',{staticStyle:{"float":"left"}},[_vm._m(0)," ",_vm._h('button',{on:{"click":_vm.BATTERY_CHARGE}},["Charge"])])," ",_vm._h('fieldset',{staticStyle:{"float":"left"}},[_vm._m(1)," ",_vm._h('crafting')])," ",_vm._h('div',{staticStyle:{"float":"right"}},[_vm._h('watch')," ",_vm._h('inventory')," ",_vm._h('battery')])])}
...
},{"./battery.vue":15,"./crafting.vue":16,"./inventory.vue":17,"./watch.vue":19,"vue":4,"vue-hot-reload-api":3,"vuex":6}],19:[function(require,module,exports){
;(function(){
'use strict';
