...
var _HydroDam = require('./HydroDam');

var _HydroDam2 = _interopRequireDefault(_HydroDam);

var _SolarPanel = require('./SolarPanel');

var _SolarPanel2 = _interopRequireDefault(_SolarPanel);
...
var Copper = {
    ...
    requires: {
        get energy() {
            return Math.floor(20 * Math.pow(1.01, _store2.default.state.stats.crafting[Copper.type] || 0));
        }
    }
};
...
var Iron = {
    ...
    requires: {
        get energy() {
            return Math.floor(10 * Math.pow(1.01, _store2.default.state.stats.crafting[Iron.type] || 0));
        }
    }
};
...
var Silicon = {
    ...
    requires: {
        get energy() {
            return Math.floor(25 * Math.pow(1.01, _store2.default.state.stats.crafting[Silicon.type] || 0));
        }
    }
};
...
var _Copper2 = _interopRequireDefault(_Copper);

var _Iron = require('./Iron');

var _Iron2 = _interopRequireDefault(_Iron);

var _Silicon = require('./Silicon');

var _Silicon2 = _interopRequireDefault(_Silicon);
...
var fromCategory = function fromCategory(category) {
...
// wind force
_store2.default.dispatch('startWindForce');
...
exports.startBatteryCharge = exports.startWindForce = exports.startTime = exports.craft = undefined;
...
var windForceHandle;
var startWindForce = exports.startWindForce = function startWindForce(_ref2) {
    ...
    windForceHandle = setInterval(function () {
        var force = (0, _utils.windForce)();
        commit('SET_WIND_FORCE', { force: force });
    }, 1000);
};
...
var inventoryIsEmpty = exports.inventoryIsEmpty = function inventoryIsEmpty(state) {
...
exports.ENERGY_ADD = exports.SET_WIND_FORCE = exports.SET_TIME = exports.BATTERY_DISCHARGE = exports.BATTERY_CHARGE = exports.INVENTORY_REMOVE = exports.INVENTORY_ADD = undefined;
...
var ENERGY_ADD = exports.ENERGY_ADD = function ENERGY_ADD(state, data) {
    ...
    if (state.stats.crafting[data.type]) {
        ...
        state.stats.crafting = _extends({}, state.stats.crafting, _defineProperty({}, data.type, amount));
    }
};

},{"./store":24}],22:[function(require,module,exports){
"use strict";
...
},{"../utils":25,"./actions":19,"./getters":20,"./mutations":21,"./state/energy":22,"./state/inventory":23,"vue":4,"vuex":6}],25:[function(require,module,exports){
"use strict";
...
var windForce = exports.windForce = function windForce() {
    var now = Date.now();
    var maxForce = 100;
    var x = now / 20000;
    var y = ((Math.sin(x) + Math.sin(x / 5.2) + Math.sin((x + 0.2) / 2.1)) / 3 + 1) / 2;
...
},{"vue":4,"vue-hot-reload-api":3,"vueify/lib/insert-css":5,"vuex":6}],27:[function(require,module,exports){
...
var _text = require('../js/helpers/text');

var text = _interopRequireWildcard(_text);

var _crafting = require('../js/crafting');
...
exports.default = {
    ...
    methods: _extends({}, (0, _vuex.mapActions)(['craft']), text, {
...
},{"../js/crafting":16,"../js/helpers/text":17,"vue":4,"vue-hot-reload-api":3,"vueify/lib/insert-css":5,"vuex":6}],28:[function(require,module,exports){
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert(".energy-items .icon-container {\n    padding: 0 0.5em 0.5em 0;\n    line-height: 0.5ex;\n    font-size: 3em;\n}\n\n.energy-items .icon-wrapper {\n    display: inline-block;\n    height: 0.5em;\n    width: 0.5em;\n    overflow: visible;\n}\n\n.energy-items .icon-wrapper .icon {\n    height: 1em;\n}")
;(function(){
'use strict';
...
},{"../js/crafting":16,"vue":4,"vue-hot-reload-api":3,"vueify/lib/insert-css":5}],29:[function(require,module,exports){
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert(".inventory .icon {\n    height: 2em;\n}\n\n.inventory .tag {\n    font-size: 1.3em;\n}\n\n.inventory .list-group-item:first-child {\n    border-top: 0px;\n}\n.inventory .list-group-item:last-child {\n    border-bottom: 0px;\n}")
;(function(){
'use strict';
...
exports.default = {
    computed: _extends({}, (0, _vuex.mapGetters)(['inventoryIsEmpty']), {
...
},{"../js/crafting":16,"vue":4,"vue-hot-reload-api":3,"vueify/lib/insert-css":5,"vuex":6}],30:[function(require,module,exports){
...
var _energy = require('./energy.vue');
...
},{"./battery.vue":26,"./crafting.vue":27,"./energy.vue":28,"./inventory.vue":29,"./watch.vue":31,"vue":4,"vue-hot-reload-api":3,"vueify/lib/insert-css":5,"vuex":6}],31:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;return _vm._h('span',["\n    "+_vm._s(_vm.formattedTime)+"\n"])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"moment":1,"vue":4,"vue-hot-reload-api":3}]},{},[18])
